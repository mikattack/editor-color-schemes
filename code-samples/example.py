# FROM: https://github.com/dbader/schedule/blob/master/schedule/__init__.py
# The MIT License (MIT)
...
class Scheduler(object):
    ...
    # Bad syntax to test highlighting
    # FIXME: More customizations
    deff intentionally_invalid(a, b, c):
        non_existent_fn(a, b, c)
    pass
